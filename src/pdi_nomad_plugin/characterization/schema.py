...
class PirometerTemperature(TimeSeries):
    """
    The temperature of the substrate measured by a pirometer.
    """
...
class PirometryCurrent(TimeSeries):
    """
    The current measured during the pirometry experiment.
    """
...
class CurrentVsTime(ArchiveSection):
    ...
    wavelength = Quantity(
        ...
        unit='meter',
        description="""
        Wavelength of the light used for the pirometry measurement.
        """,
        a_eln=ELNAnnotation(
    ...
    incidence_angle = Quantity(
        ...
        unit='degree',
        description="""
        The angle of incidence of the light used for the pirometry measurement.
        """,
        a_eln=ELNAnnotation(
            component=ELNComponentEnum.NumberEditQuantity,
    ...
    current = SubSection(
        section_def=PirometryCurrent,
    )


class Pirometry(Measurement, EntryData):
    """
    Class autogenerated from yaml schema.
    """
    ...
    pirometer_temperature = SubSection(
        section_def=PirometerTemperature,
    )
