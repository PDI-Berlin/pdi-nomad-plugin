...
class SubstrateCrystalPropertiesMbe(SubstrateCrystalProperties):
    """
    ...
    miscut = SubSection(section_def=MiscutMbe)
...
class SubstrateInventory(EntryData, TableData):
    ...
    substrates = SubSection(
        section_def=SubstrateMbeReference,
        repeats=True,
    )
    steps = SubSection(
